...
newNode.setAttribute("placeholder" , "Введите опыт");
...
newNode.classList.add ("mt-2");
newNode.setAttribute("placeholder" , "Введите ");
newNode.setAttribute("rows" , 2);
...
newNode.classList.add ("mt-2");
newNode.setAttribute("placeholder" , "Введите навык");
...
newNode.classList.add ("mt-2");
newNode.setAttribute("placeholder" , "Введите язык");
newNode.setAttribute("rows" , 1);
